...
#' is coded \samp{37F3}.
#' @author \enc{SigurðurSigurdur} \enc{ÞórThor} \enc{JónssonJonsson} with
#' contributions from \enc{ÁstaAsta} \enc{GuðmundsdóttirGudmundsdottir} and
#' \enc{ÁrniArni} \enc{MagnússonMagnusson}.
