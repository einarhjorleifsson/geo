...
#' }
#' @export s2pre
s2pre <- function(data, file = "splus.pre", na.replace = "")
{
  # data :matrix or data.frame.  na.replace :a character to replace NA
  # with.  VALUE :a prelude file, named 'Splus.pre' by default.
